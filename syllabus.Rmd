...
- Professor: Virtual from 1:30-2:30pm on Mondays. Zoom link TBD.

- Teaching Assistants: Time TBD.  Zoom link TBD.
...
- Identify and answer questions that involve applying statistical models to data.

- Work individually and in a team to solve statistical problems.

- Present the results and limitations of a statistical analysis at appropriate technical levels for the intended audience.
...
* If you are new to R, you could look at [Quick-R](https://www.statmethods.net). 
* For more experienced users, the [Cheatsheets](https://www.rstudio.com/resources/cheatsheets/) are invaluable.  
